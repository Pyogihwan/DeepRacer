        ...
        namespace rawdata
        {
            namespace skeleton
            {
                ...
                SvRawDataSkeletonImpl::SvRawDataSkeletonImpl(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode)
                    : SvRawDataSkeleton(instanceSpec, mode), m_logger(ara::log::CreateLogger("SENS", "PORT", ara::log::LogLevel::kVerbose)), m_RField{0U, 0U, 0U}
                {
...
namespace sensor
{
    namespace aa
    {
        namespace port
        {
            ...
            RawData::RawData()
                : m_logger(ara::log::CreateLogger("SENS", "PORT", ara::log::LogLevel::kVerbose)), m_running{false}, m_REventData{0U, 0U, 0U}
            {
            }
