...
namespace calc
{
    namespace aa
    {
        namespace port
        {
            ...
            RawData::RawData()
                : m_logger(ara::log::CreateLogger("CALC", "PORT", ara::log::LogLevel::kVerbose)), m_running{false}, m_found{false}
            {
            }
            ...
            void RawData::Find(ara::com::ServiceHandleContainer<deepracer::service::rawdata::proxy::SvRawDataProxy::HandleType> handles, ara::com::FindServiceHandle findHandle)
            {
                ...
                else
                {
                    ...
                    {
                        m_logger.LogVerbose() << "RawData::Find::Searched Instance::ServiceId =" << handle.GetServiceHandle().serviceId << ", InstanceId =" << handle.GetServiceHandle().instanceId;
                    }
                }
                ...
                {
                    m_logger.LogVerbose() << "RawData::Find::Using Instance::ServiceId =" << handles[0].GetServiceHandle().serviceId << ", InstanceId =" << handles[0].GetServiceHandle().instanceId;
