...
/// GENERATED DATE                    : 2024-11-14 15:25:12
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///                                                                                                        
...
public:
    ...
    using SampleType = deepracer::type::Uint8Vector;
    /// @brief Constructor
...
public:
    ...
    /// @uptrace{SWS_CM_00162, SWS_CM_90437}
    using FieldType = deepracer::type::Uint8Vector;
    /// @brief Constructor
...
public:
    ...
    /// @uptrace{SWS_CM_00191}
    virtual ara::core::Future<RMethodOutput> RMethod(const double& a, const deepracer::type::Arithmetic& artihmetic, const double& b) = 0;
...
private:
    void HandleRMethod(const std::vector<std::uint8_t>& data, const para::com::MethodToken token)
    {
        ...
        para::serializer::Deserializer deserializer{data};
        double _a_;
        deepracer::type::Arithmetic _artihmetic_;
        double _b_;
        deserializer.read(_a_);
        deserializer.read(_artihmetic_);
        deserializer.read(_b_);
        auto future = RMethod(_a_, _artihmetic_, _b_);
        auto result = future.GetResult();
        if (result.HasValue())
        {
