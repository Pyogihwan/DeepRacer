...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "deepracer/service/lidar/svlidardata_proxy.h"
...
public:
    ...
    void ReadDataLEvent(ara::com::SamplePtr<deepracer::service::lidar::proxy::events::LEvent::SampleType const> samplePtr);
    
    
    
private:
    /// @brief Callback for find service
    void Find(ara::com::ServiceHandleContainer<deepracer::service::lidar::proxy::SvLidarDataProxy::HandleType> handles,
...
private:
    ...
    std::shared_ptr<deepracer::service::lidar::proxy::SvLidarDataProxy> m_interface;
