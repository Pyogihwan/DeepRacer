        ...
        namespace deepracerfg
        {
            namespace skeleton
            {
                ...
                TriggerInOut_DeepRacerFGSkeletonImpl::TriggerInOut_DeepRacerFGSkeletonImpl(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode)
                    : TriggerInOut_DeepRacerFGSkeleton(instanceSpec, mode), m_logger(ara::log::CreateLogger("SM", "PORT", ara::log::LogLevel::kVerbose)), m_DeepRacerFGState{ara::sm::DeepRacerStateType::kOff}
                {
                    // create state client
    ...
    namespace para
    {
        namespace port
        {
            ...
            DeepRacerFG::DeepRacerFG()
                : m_logger(ara::log::CreateLogger("SM", "PORT", ara::log::LogLevel::kVerbose)), m_running{false}
            {
            }
