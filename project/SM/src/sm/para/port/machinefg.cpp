        ...
        namespace machinefg
        {
            namespace skeleton
            {
                ...
                TriggerInOut_MachineFGSkeletonImpl::TriggerInOut_MachineFGSkeletonImpl(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode)
                    : TriggerInOut_MachineFGSkeleton(instanceSpec, mode), m_logger(ara::log::CreateLogger("SM", "PORT", ara::log::LogLevel::kVerbose)), m_MachineFGState{ara::sm::MachineStateType::kOff}
                {
                    // create state client
